...
END_OF_ROUND_TUNE_0C:   EQU $19
LOSE_LIFE_TUNE_0A:      EQU $1A
LOSE_LIFE_TUNE_0B:      EQU $1B
BLUE_CHOMPER_SND_0A:    EQU $1C
BLUE_CHOMPER_SND_0B:    EQU $1D
VERY_GOOD_TUNE_0A:      EQU $1E
VERY_GOOD_TUNE_0B:      EQU $1F
VERY_GOOD_TUNE_0C:      EQU $20
SFX_COIN_INSERT_SND:    EQU $21
NO_EXTRA_TUNE_0D:       EQU $22
NO_EXTRA_TUNE_0E:       EQU $23
TWINKLE_TWINKLE_0A:     EQU $24 
TWINKLE_TWINKLE_0B:     EQU $25
OPENING_TUNE_SND_0C:    EQU $26
LOSE_LIFE_TUNE_0C:      EQU $27
GAME_OVER_TUNE_0C:      EQU $28
...
PLAY_OPENING_TUNE:
    ...
    CALL    PLAY_IT
    LD      B,OPENING_TUNE_SND_0C     ; Play third part of opening tune
    CALL    PLAY_IT
    LD      A,(SOUND_BANK_01_RAM)
    AND     0C0H
    OR      2
...
PLAY_BACKGROUND_TUNE:
    LD      A,0FFH
    LD      (SOUND_BANK_02_RAM),A ; free bg voice 2's bank so PLAY_IT can't skip it if bank2
                                  ; is momentarily still busy at the opening->bg handoff
...
PLAY_EXTRA_WALKING_TUNE_NO_CHOMPERS:
    LD      A,0FFH                  ; free all 3 opening-tune voices (banks 1,2,3) so none
    LD      (SOUND_BANK_01_RAM),A   ; of them (ch1/ch2/ch0) clash with the extra-walking tune
    LD      (SOUND_BANK_02_RAM),A
    LD      (SOUND_BANK_03_RAM),A
...
SOUND_TABLE:
    ...
    DW SOUND_BANK_04_RAM
    DW NEW_OPENING_TUNE_P3
    DW SOUND_BANK_03_RAM
    DW LOSE_LIFE_TUNE_P3
    DW SOUND_BANK_03_RAM
    DW GAME_OVER_TUNE_P3
    DW SOUND_BANK_03_RAM
...
BOUNCING_BALL_SOUND_P1:
    DB 130,075,129,006,194,051,152   ; div 379 → 331  (was byte2 123)
BOUNCING_BALL_SOUND_P2:
    DB 194,161,129,006,194,051,216   ; div 478 → 417  (was byte2 222)
BALL_STUCK_SOUND:
    DB 192,102,033,003
    DB 192,179,016,003
    DB 192,239,000,003
...
LOSE_LIFE_TUNE_P1:
    DB 064,035,080,008          ; div 40 → 35
    DB 064,028,080,008,106      ; div 32 → 28   + rest 10
    DB 064,007,081,008          ; div 301 → 263 (hi 1)
    DB 064,186,080,008,106      ; div 213 → 186 + rest 10
    DB 064,093,080,008          ; div 106 → 93
    DB 064,065,080,008,106      ; div 75 → 65   + rest 10
    DB 064,190,082,008          ; div 804 → 702 (hi 2)
    DB 066,067,083,030,026,051  ; div 956 → 835 (hi 3) — swept fade to silence
    DB 080                      ; END

LOSE_LIFE_TUNE_P2:
    DB 128,041,096,008          ; div 47 → 41
    DB 128,035,096,008,170      ; div 40 → 35   + rest 10
    DB 128,196,096,008          ; div 225 → 196
    DB 128,221,096,008,170      ; div 253 → 221 + rest 10
    DB 128,078,096,008          ; div 89 → 78
    DB 128,087,096,008,170      ; div 100 → 87  + rest 10
    DB 128,095,097,008          ; div 402 → 351 (hi 1)
    DB 130,161,097,030,025,051  ; div 478 → 417 (hi 1) — swept fade
    DB 144                      ; END

LOSE_LIFE_TUNE_P3:
    DB 192,052,096,008          ; div 60 → 52
    DB 192,041,096,008,234      ; div 47 → 41   + rest 10
    DB 192,156,096,008          ; div 179 → 156
    DB 192,139,096,008,234      ; div 159 → 139 + rest 10
    DB 192,065,096,008          ; div 75 → 65
    DB 192,117,096,008,234      ; div 134 → 117 + rest 10
    DB 192,176,096,008          ; div 201 → 176
    DB 194,209,096,030,025,051  ; div 239 → 209 — swept fade
    DB 208                      ; END
...
EXTRA_WALKING_TUNE_P1:
    ; phrase A (plays twice)
    DB 064,104,032,006,100  ; div104
    DB 064,139,048,006,100  ; div139
    DB 064,139,048,006,100
    DB 064,139,048,006,100
    DB 064,104,032,006,100
    DB 064,139,048,006,100
    DB 064,139,048,006,100
    DB 064,139,048,006,100
    ; phrase B (twice)
    DB 064,124,032,006,100  ; div124
    DB 064,156,048,006,100  ; div156
    DB 064,156,048,006,100
    DB 064,156,048,006,100
    DB 064,124,032,006,100
    DB 064,156,048,006,100
    DB 064,156,048,006,100
    DB 064,156,048,006,100
    ; phrase C (twice)
    DB 064,139,032,006,100
    DB 064,111,048,006,100  ; div111
    DB 064,111,048,006,100
    DB 064,111,048,006,100
    DB 064,139,032,006,100
    DB 064,111,048,006,100
    DB 064,111,048,006,100
    DB 064,111,048,006,100
    ; phrase D (once)
    DB 064,111,032,006,100
    DB 064,093,048,006,100  ; div93
    DB 064,093,048,006,100
    DB 064,093,048,006,100
    DB 064,093,032,006,100
    DB 064,104,048,006,100
    DB 064,104,048,006,114  ; + rest 18
    DB 088                  ; END + REPEAT
EXTRA_WALKING_TUNE_P2:
    ; block 1  (div209 / div278) ×8
    DB 128,209,032,003,162
    DB 128,022,033,003,162
    DB 128,209,032,003,162
    DB 128,022,033,003,162
    DB 128,209,032,003,162
    DB 128,022,033,003,162
    ...
    DB 128,209,032,003,162
    DB 128,022,033,003,162
    ; block 2  (div248 / div313) ×8
    DB 128,248,032,003,162
    DB 128,057,033,003,162
    DB 128,248,032,003,162
    DB 128,057,033,003,162
    DB 128,248,032,003,162
    DB 128,057,033,003,162
    ...
    DB 128,248,032,003,162
    DB 128,057,033,003,162
    ; block 3  (div278 / div221) ×8
    DB 128,022,033,003,162
    DB 128,221,032,003,162
    DB 128,022,033,003,162
    DB 128,221,032,003,162
    DB 128,022,033,003,162
    DB 128,221,032,003,162
    ...
    DB 128,022,033,003,162
    DB 128,221,032,003,162
    ; block 4  (div221 / div186) ×4
    DB 128,221,032,003,162
    DB 128,186,032,003,162
    DB 128,221,032,003,162
    DB 128,186,032,003,162
    DB 128,221,032,003,162
    DB 128,186,032,003,162
    ...
    DB 128,186,032,003,162
    ; tail
    DB 128,093,032,006,164
    DB 128,124,048,006,164
    DB 128,124,048,006,178
    DB 152                  ; END + REPEAT
GAME_OVER_TUNE_P1:
    DB 064,156,000,009,105 ; div 179→156
    DB 064,104,000,007,098 ; div 119→104
    DB 064,104,000,007,098
    DB 064,124,000,018     ; div 142→124  (no rest)
    DB 064,156,000,009,105
    DB 064,156,000,009,105
    DB 064,104,000,007,098
    DB 064,104,000,007,098
    DB 064,124,000,018     ; (no rest)
    DB 064,156,000,009,105
    DB 064,139,000,009,105 ; div 159→139
    DB 064,104,000,007,098
    DB 064,104,000,007,098
    DB 064,104,000,036,114 ; long note
    DB 064,209,000,009,105 ; div 239→209
    DB 064,156,000,009     ; last
    DB 080                 ; END

GAME_OVER_TUNE_P2:
    DB 128,057,097,009,169 ; div 358→313 (hi 1)
    DB 128,161,097,007,162 ; div 478→417 (hi 1)
    DB 128,161,097,007,162
    DB 128,116,097,018     ; div 426→372 (hi 1, no rest)
    DB 128,057,097,009,169
    DB 128,057,097,009,169
    DB 128,161,097,007,162
    DB 128,161,097,007,162
    DB 128,116,097,018     ; (no rest)
    DB 128,057,097,009,169
    DB 128,022,097,009,169 ; div 319→278 (hi 1)
    DB 128,161,097,007,162
    DB 128,161,097,007,162
    DB 128,161,097,036,178 ; long note
    DB 128,161,097,009,169
    DB 128,057,097,009     ; last
    DB 144                 ; END

GAME_OVER_TUNE_P3:
    DB 192,248,048,018     ; div 284→248
    DB 192,209,048,018     ; div 239→209
    DB 192,248,048,018
    DB 192,209,048,018
    DB 192,248,048,018
    DB 192,209,048,018
    DB 192,248,048,018
    DB 192,209,048,018
    DB 192,022,049,018     ; div 319→278 (hi 1)
    DB 192,209,048,018
    DB 192,022,049,018     ; div 319→278 (hi 1)
    DB 192,209,048,018,242 ; + rest 18
    DB 192,067,067,009,233 ; div 956→835 (hi 3, atten 4) + rest 9
    DB 192,113,066,009     ; div 716→625 (hi 2, atten 4)  last
    DB 208                 ; END

END_OF_ROUND_TUNE_P1:
      DB 064,209,032,004,100  ; was 239
      DB 064,156,032,004,100  ; was 179
      DB 064,124,032,004,100  ; was 142
      DB 064,104,032,009,105  ; was 119
      DB 064,124,032,003,099  ; was 142
      DB 064,104,032,024      ; was 119  (held)
      DB 080
END_OF_ROUND_TUNE_P2:
      DB 128,240,033,004,164  ; div 496  (was 568)
      DB 128,161,033,004,164  ; div 417  (was 478)
      DB 128,057,033,004,164  ; div 313  (was 358)
      DB 128,248,032,009,169  ; div 248  (was 284)
      DB 128,057,033,003,163  ; div 313
      DB 128,248,032,024      ; div 248  (held)
      DB 144

END_OF_ROUND_TUNE_P3:
      DB 192,104,032,004,228  ; was 119
      DB 192,078,032,004,228  ; was 089
      DB 192,062,032,004,228  ; was 071
      DB 192,052,032,009,233  ; was 060
      DB 192,062,032,003,227  ; was 071
      DB 192,052,032,024      ; was 060  (held)
      DB 208


TWINKLE_TWINKLE_P1:
 DB 128,000,240,208      ; one long silent "rest" = phrases 1 + 2 (208 frames)
    ; phrase 3 — original notes, byte-for-byte
    DB 128,161,033,006
    DB 128,022,033,006,161
    DB 128,075,033,006
    DB 128,022,033,006,161
    DB 128,161,033,006
    DB 128,022,033,006,161
    ...
    DB 128,022,033,006,161
    DB 128,161,033,006
    DB 128,248,032,006,161
    DB 128,039,033,006
    DB 128,248,032,006,161
    DB 128,161,033,006
    DB 128,022,033,006
    DB 128,075,033,006
    DB 128,022,033,006,162
    ; phrase 4 — original notes, byte-for-byte
    DB 128,186,033,006
    DB 128,022,033,006,161
    DB 128,116,033,006
    DB 128,022,033,006,161
    ...
    DB 128,075,033,006
    DB 128,022,033,006
    DB 128,161,033,012,162
    DB 144                  ; END

TWINKLE_TWINKLE_P2:
      ; phrase 1  (play TWICE — phrase 2 is identical)
    DB 064,070,016,012,097
    DB 064,070,016,012,097
    DB 064,078,016,012,097
    DB 064,078,016,012,097
    DB 064,083,016,012,097
    DB 064,083,016,012,097
    DB 064,093,016,024,098
    DB 064,070,016,012,097
    DB 064,070,016,012,097
    DB 064,078,016,012,097
    DB 064,078,016,012,097
    ...
    DB 064,083,016,012,097
    DB 064,093,016,024,098
    ; >>> repeat the 7 lines above here for phrase 2 <<<
    ; phrase 3
    DB 064,209,016,012,097
    DB 064,209,016,012,097
    DB 064,139,016,012,097
    DB 064,139,016,012,097
    DB 064,124,016,012,097
    DB 064,124,016,012,097
    DB 064,139,016,024,098
    ; phrase 4
    DB 064,156,016,012,097
    DB 064,156,016,012,097
    DB 064,166,016,012,097
    DB 064,166,016,012,097
    DB 064,186,016,012,097
    DB 064,186,016,012,097
    DB 064,209,016,024,098
    DB 080                  ; END
NEW_BACKGROUND_TUNE_P1:
 DB 128,156,128,005,164  ; (was note 17)
    DB 128,139,128,005,164
    DB 128,156,128,005,164
    DB 128,139,128,005,164
    DB 128,156,128,005,164
    DB 128,186,128,005,164
    DB 128,139,128,005,164
    DB 128,156,128,005,164
    DB 128,166,128,005,164
    DB 128,022,129,005,164
    DB 128,186,128,005,164
    DB 128,156,128,005,164
    DB 128,166,128,005,164
    DB 128,186,128,005,164
    DB 128,209,128,005,164
    DB 128,156,128,005,164  ; (was note 32 — end of original)
    DB 128,166,128,005,164  ; (was note 1)
    DB 128,139,128,005,164
    DB 128,166,128,005,164
    DB 128,139,128,005,164
    DB 128,156,128,005,164
    ...
    DB 128,156,128,005,164
    DB 128,209,128,005,164
    DB 128,186,128,005,164  ; (was note 16 — now last)
    DB 152                 ; END + REPEAT
NEW_OPENING_TUNE_P1:
      DB 171
      ...
      DB 128,075,097,006,164
      DB 128,075,097,006,164
      DB 128,116,097,006,164  ; was 170
      DB 128,116,097,006,164
      DB 128,116,097,006,164
      DB 128,116,097,006,164
      DB 128,075,097,006,164  ; was 123
      DB 128,116,097,006,164  ; was 170
      DB 128,161,097,006,164  ; was 222
      DB 128,186,097,006,164  ; was 250
...
NEW_OPENING_TUNE_P3:
      DB 235
      DB 192,139,096,006,228  ; was 159
      DB 192,166,096,006,228  ; was 190
      DB 192,166,096,006,228
      DB 192,166,096,006,228
      DB 192,156,096,006,228  ; was 179
      DB 192,186,096,006,228  ; was 213
      DB 192,186,096,006,228
      DB 192,186,096,006,228
      DB 192,139,096,006,228  ; was 159
      DB 192,156,096,006,228  ; was 179
      DB 192,166,096,006,228  ; was 190
      DB 192,186,096,006,228  ; was 213
      DB 192,209,096,012      ; was 239 (held)
      DB 254                  ; rest 30
      DB 208                  ; terminator

NEW_BACKGROUND_TUNE_P2:
    DB 064,116,097,009,105  ; (was note 12)
    DB 064,116,097,009,105
    DB 064,116,097,005,100
    DB 064,057,097,005,100
    DB 064,075,097,005,100
    DB 064,116,097,005,100
    DB 064,161,097,005,100
    DB 064,209,096,005,100
    DB 064,221,096,005,100
    DB 064,248,096,005,100
    DB 064,022,097,005,100
    DB 064,057,097,005,100
    DB 064,075,097,005,100
    DB 064,116,097,005,100  ; (was note 25 — end of original)
    DB 064,161,097,024,108  ; (was note 1 — the long lead-in note)
    DB 064,116,097,005,100
    DB 064,057,097,005,100
    DB 064,075,097,005,100
    DB 064,116,097,005,100
    DB 064,022,097,009,105
    DB 064,022,097,009,105
    DB 064,022,097,005,100
    DB 064,248,096,005,100
    DB 064,075,097,005,100
    DB 064,057,097,005,100  ; (was note 11 — now last)
    DB 088                 ; END + REPEAT
   
NEW_BLUE_CHOMPER_SOUND_0A:
    DB 064,057,049,008,104  ; div313 (hi1), dur8 + rest8
    DB 064,234,048,004,100  ; div234
    DB 064,234,048,004,100
    DB 064,022,049,004,100  ; div278 (hi1)
    DB 064,234,048,004,100
    DB 064,234,048,004,100
    DB 064,022,049,004,100  ; div278 (hi1)
    DB 088                  ; END + REPEAT
NEW_BLUE_CHOMPER_SOUND_0B:
    DB 128,116,049,004,164  ; div372
    DB 128,116,049,004,164
    DB 128,212,049,004,164  ; div468
    DB 128,116,049,004,164
    DB 128,095,049,004,164  ; div351
    DB 128,095,049,004,164
    DB 128,212,049,004,164  ; div468
    DB 128,095,049,004,164
    DB 152                  ; END + REPEAT
...
NEW_WIN_EXTRA_DO_TUNE_P1:
      DB 064,166,000,018,097  ; div190→166
      DB 064,166,000,018,097
      DB 064,166,000,009
      DB 064,156,000,018,097  ; div179→156
      DB 064,148,000,009      ; div169→148
      DB 064,139,000,036      ; div159→139
      DB 064,139,000,009,097
      DB 064,139,000,009,097
      DB 064,148,000,009,097
      DB 064,139,000,009
      DB 064,124,000,018,097  ; div142→124
      DB 064,124,000,018,097
      DB 064,124,000,009
      DB 064,111,000,018,097  ; div127→111
      DB 064,104,000,009      ; div119→104
      DB 064,083,000,036,097  ; div95→83
      DB 114                  ; rest 18
      DB 064,078,000,009,097  ; div89→78
      DB 064,083,000,009,097
      DB 064,093,000,036      ; div106→93
      DB 064,124,000,018,097
      DB 064,083,000,009,097
      DB 064,093,000,009,097
      DB 064,104,000,036
      DB 064,139,000,018,097
      DB 064,148,000,009,097
      DB 064,139,000,009,097
      DB 064,124,000,018,097
      DB 064,124,000,018,097
...
NEW_WIN_EXTRA_DO_TUNE_P2:
    DB 128,161,033,009      ; div478→417
    DB 128,022,033,009,161  ; div319→278
    DB 128,075,033,009      ; div379→331
    DB 128,022,033,009,161
    DB 128,161,033,009
    DB 128,022,033,009
    DB 128,075,033,009,161
    DB 128,022,033,009
    DB 128,161,033,009
    DB 128,022,033,009
    DB 128,075,033,009
    DB 128,022,033,009
    DB 128,161,033,009,161
    DB 128,022,033,009,161
    DB 128,075,033,009,161
    DB 128,022,033,009
    DB 128,161,033,009
    DB 128,248,032,009,161  ; div284→248
    DB 128,057,033,009      ; div358→313
    DB 128,248,032,009,161
    DB 128,161,033,009
    DB 128,248,032,009
    DB 128,057,033,009,161
    DB 128,248,032,009
    DB 128,161,033,009
    DB 128,209,032,009      ; div239→209
    DB 128,022,033,009
    DB 128,209,032,009,161
    DB 128,075,033,009
    DB 128,209,032,009
    DB 128,248,032,009,161
    DB 128,209,032,009,161
    DB 128,057,033,055      ; div313 held 55 frames
    DB 180                 ; rest 20
    DB 128,075,033,055      ; div331 held 55 frames
    DB 180                  ; rest 20
    DB 128,075,033,009
    DB 128,248,032,009,161
    DB 128,039,033,009      ; div338→295
    DB 128,248,032,009,161
    DB 128,075,033,009
    DB 128,022,033,009
    DB 128,057,033,009,161
    ...
    DB 128,161,033,009,161
    DB 170                  ; rest 9
    DB 128,161,033,010      ; div478→417
    DB 169                  ; rest 9
    DB 144                  ; END

VERY_GOOD_TUNE_P1:
  ; --- phrase 1 ---
    DB 064,073,000,006      ; div 84→73
    DB 064,070,000,006      ; div 80→70
    DB 097                  ; rest 1
    DB 064,083,000,008,101  ; div 95→83  + rest 5   ]
    DB 064,083,000,008,101  ; (repeat)              ] ROM loop ×3
    DB 064,083,000,008,101  ; (repeat)              ]
    DB 064,073,000,006      ; div 84→73
    DB 064,070,000,006      ; div 80→70
    DB 097                  ; rest 1
    DB 064,083,000,008,101  ; div 95→83
    DB 064,083,000,008,101
    DB 064,041,000,008,101  ; div 47→41
    DB 064,046,000,006,097  ; div 53→46
    DB 064,052,000,006,097  ; div 60→52
    DB 064,055,000,006,097  ; div 63→55
    DB 064,062,000,006,097  ; div 71→62
    DB 064,070,000,012      ; div 80→70
    DB 064,078,000,012      ; div 89→78
    DB 064,083,000,008,101  ; div 95→83
    DB 064,078,000,008,101  ; div 89→78
    DB 064,070,000,012      ; div 80→70
    DB 110                  ; rest 14
    ; --- phrase 2 ---
    DB 064,073,000,006
    DB 064,070,000,006
    DB 097                  ; rest 1
    DB 064,083,000,008,101  ; ] ROM loop ×3
    DB 064,083,000,008,101  ; ]
    DB 064,083,000,008,101  ; ]
    DB 064,073,000,006
    DB 064,070,000,006
    ...
    DB 064,083,000,008,101
    DB 064,083,000,008,101
    DB 064,041,000,008,101
    DB 064,046,000,006,097
    DB 064,052,000,006,097
    DB 064,055,000,006,097
    DB 064,062,000,006,097
    DB 064,070,000,012
    DB 064,055,000,012      ; div 63→55
    DB 064,052,000,008,101  ; div 60→52
    DB 064,041,000,008,101  ; div 47→41
    DB 064,052,000,012      ; div 60→52
    DB 080                  ; END (plays once)
VERY_GOOD_TUNE_P2:
    ; phrase 1 (plays twice — ROM loop)
    DB 128,039,033,006      ; div 338→295
    DB 128,022,033,006      ; div 319→278
    DB 161                  ; rest 1
    DB 128,075,033,008,165  ; div 379→331 + rest5
    DB 128,067,035,008,165  ; div 956→835 + rest5
    DB 128,161,033,008,165  ; div 478→417 + rest5
    DB 128,039,033,006      ; (repeat)
    DB 128,022,033,006
    DB 161
    DB 128,075,033,008,165
    DB 128,067,035,008,165
    DB 128,161,033,008,165
    ; descending run
    DB 128,186,033,006,161  ; div 506→442 + rest1
    DB 128,240,033,006,161  ; div 568→496 + rest1
    DB 128,045,034,006,161  ; div 638→557 + rest1
    DB 128,113,034,006,161  ; div 716→625 + rest1
    DB 128,150,034,012      ; div 758→662
    DB 128,231,034,012      ; div 851→743
    DB 128,067,035,008,165  ; div 956→835 + rest5
    DB 128,231,034,008,165  ; div 851→743 + rest5
    DB 128,150,034,008,165  ; div 758→662 + rest5
    DB 128,150,034,008,165  ; (repeat)
    ; phrase 2 (plays twice — ROM loop)
    DB 128,039,033,006
    DB 128,022,033,006
    DB 161
    DB 128,075,033,008,165
    ...
    DB 128,067,035,008,165
    DB 128,161,033,008,165
    DB 128,186,033,006,161
    DB 128,240,033,006,161
    DB 128,045,034,006,161
    DB 128,113,034,006,161
    DB 128,150,034,012
    DB 128,231,034,012
    DB 128,150,034,008,165  ; div 758→662 + rest5
    DB 128,067,035,008,165  ; div 956→835 + rest5
    DB 128,150,002,012      ; div 758→662 (atten 0)
    DB 178                  ; rest 18
    DB 144                  ; END

VERY_GOOD_TUNE_P3:
   ; loop A (plays 3×)
    DB 192,067,035,008,229  ; div 956→835
    DB 192,067,035,008,229
    DB 192,150,034,008,229  ; div 758→662
    DB 192,067,035,008,229
    DB 192,067,035,008,229
    DB 192,067,035,008,229
    DB 192,150,034,008,229
    DB 192,067,035,008,229
    DB 192,067,035,008,229
    DB 192,067,035,008,229
    DB 192,150,034,008,229
    ...
    DB 192,067,035,008,229
    DB 192,150,034,008,229
    DB 192,067,003,012      ; div 956→835 (atten 0)
    DB 208                  ; END
