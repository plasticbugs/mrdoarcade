...
OPENING_TUNE_SND_0C:    EQU $25
LOSE_LIFE_TUNE_0C:      EQU $26
GAME_OVER_TUNE_0C:      EQU $27
...
; TWINKLE_TWINKLE_P1:
    ...
    ; DB 128,046,032,006
    ; DB 128,035,032,006,162
    ; ; >>> repeat the 16 lines above for phrase 2 <<<
    ; ; phrase 3
    ; DB 128,161,033,006
