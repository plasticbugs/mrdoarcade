...
NEW_BACKGROUND_TUNE_P1:
    ; OVER LONG D
    ; F4 10
    DB 128,160,128,006,163
    ; G4 10
    DB 128,142,128,006,163
    ; OVER LONG D
    ; F4 10
    DB 128,160,128,006,163
    ; G4 10
    ...
    DB 128,190,128,006,163
    ; C (complements lower E) 10
    DB 128,142,128,006,163
    ; D4 (complements lower D) 10
    DB 128,160,128,006,163
    ; C4 (complements lower C) 10
    DB 128,168,160,006,163
    ; E5 (complements lower C) 10
    DB 128,071,128,006,163
    ; G on the B 10
    DB 128,190,128,006,163
    ; F on the A 10
    DB 128,160,128,006,163
    ; E on the G 10
    DB 128,169,128,006,163
    ; D on the F 10
    DB 128,190,128,006,163
    ; C on the E 10
    DB 128,213,128,006,163
    ; B on the D 20
    DB 128,160,128,006,163
...
NEW_BACKGROUND_TUNE_P2:
    ; Note 12: D3
    DB 064,124,097,008,106
    ; Note 13: D3
    DB 064,124,097,008,106

    ; Note 14: D3
    DB 064,124,097,006,099

    ; Note 15: F3
    DB 064,064,097,006,099
    ; Note 16: E3
    DB 064,083,097,006,099
    ; Note 17: D3
    DB 064,124,097,006,099
    ; Note 18: C3
    DB 064,171,097,006,099
    ; Note 19: C4
    DB 064,213,096,006,099
    ; Note 20: B4
    DB 064,226,096,006,099
    ; Note 21: A4
    DB 064,254,096,006,099
    ; Note 22: G3
    DB 064,029,097,006,099
    ; Note 23: F3
    DB 064,064,097,006,099
    ; Note 24: E3
    DB 064,083,097,006,099
    ...
    DB 064,124,097,006,099
        ; Note 1: C3
    DB 064,171,097,027,106
    ; Note 2: D3
    DB 064,062,097,006,099
    ; Note 3: F3
    DB 064,064,097,006,099
    ; Note 4: E3
    DB 064,083,097,006,099
