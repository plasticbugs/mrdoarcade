...
BOUNCING_BALL_SOUND_P1:
    DB 130,123,129,006,194,051,152
BOUNCING_BALL_SOUND_P2:
    DB 194,222,129,006,194,051,216
BALL_STUCK_SOUND:
    DB 192,102,033,003
    DB 192,179,016,003
    DB 192,239,000,003
...
END_OF_ROUND_TUNE_P1:
    ...
    DB 064,239,032,004,100  ; Bb4
    DB 064,179,032,004,100  ; Eb5
    DB 064,142,032,004,100  ; G5
    DB 064,119,032,009,105  ; Bb5
    DB 064,142,032,003,099  ; G5
    DB 064,119,032,024      ; Bb5 (held)
    DB 080                  ; END (no repeat)
END_OF_ROUND_TUNE_P2:
    ; HIGH NOTES
    ; C4 Middle
    DB 128,056,034,004,164  ; Bb3-ish
    DB 128,222,033,004,164  ; Eb4
    DB 128,250,033,004,164  ; G4
    DB 128,102,033,009,169  ; Bb4
    DB 128,250,033,003,163  ; G4
    DB 128,102,033,024      ; Bb4 (held)
    DB 144                  ; END
...
END_OF_ROUND_TUNE_P3:
    DB 192,119,032,004,228  ; Bb5
    DB 192,089,032,004,228  ; Eb6
    DB 192,071,032,004,228  ; G6
    DB 192,060,032,009,233  ; Bb6
    DB 192,071,032,003,227  ; G6
    DB 192,060,032,024      ; Bb6 (held)
    DB 208                  ; END
