...
LOSE_LIFE_TUNE_P1:
  DB 064,$11,080,007,099
  DB 064,$0E,080,007,099
  DB 064+32+10
  ; DB 064,$50,080,007,099
  ; DB 064,$47,080,007,099
  ; DB 064+32+10

  ; DB 064,$21,080,007,099
  ; DB 064,$2C,080,007,099
  ; DB 064+32+10

  ; DB 064,$59,080,007,099
  ; DB 064,$6A,080,010,080
...
LOSE_LIFE_TUNE_P2:
  DB 128,$15,080,007,163
  DB 128,$11,080,007,163
  ; 10 rest (32+channel+length)
  DB 128+32+10

  DB 128,$64,080,007,163
  DB 128,$5F,080,007,144
  ; 10 rest (32+channel+length)
  DB 128+32+10

  DB 128,$28,080,007,163
  DB 128,$3B,080,007,163
  DB 128+32+10

  ; DB 128,$B3,080,007,163
  ; DB 128,$AB,081,010,144
...
LOSE_LIFE_TUNE_P3:
  DB 192,$1A,080,007,227
  DB 192,$15,080,007,227
  DB 192+32+10
  DB 192,$86,080,007,227
  DB 192,$71,080,007,227
  DB 192+32+10
  	; D# (D5)
	DB 192,089,096,007,227
	; F# (middle)
	DB 192,119,096,007,227
  DB 192+32+10
	; D# (low)
	DB 192,206,098,007,227
	; C (low)
	DB 192,086,099,007,208
  ; DB 192+32+10
  ; DB 192,$2F,080,007,227

  ; DB 192+32+10
  ; DB 192,$67,081,007,227
  ; DB 192,$56,083,010,208
