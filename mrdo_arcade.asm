...
; Mr Do impatient frame 1 (White)
MR_DO_IMPATIENT_F0_WHITE:
...
; Mr Do impatient frame 1 (red)
MR_DO_IMPATIENT_F0_RED:
...
; Mr Do impatient frame 2 (White)
MR_DO_IMPATIENT_F1_WHITE:
   DB 000,000,007,012,008,016,000,000
   DB 000,004,031,026,003,031,012,000
   DB 000,000,128,064,064,000,000,000
   DB 016,088,240,224,128,192,224,000
; Mr Do impatient frame 2 (red)
MR_DO_IMPATIENT_F1_RED:
