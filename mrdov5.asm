...
LOSE_LIFE_TUNE_P1:
    ; High B
    DB 064,056,096,007,099
    ; High C
    DB 064,053,096,007,107
    ; Sec F
    DB 064,160,096,004,099
    ; Sec G
    DB 064,142,096,007,107
    ; SEcond Highest G#
    DB 064,067,096,007,099
    ; B Flat (B5)
    DB 064,119,096,007,107
    ; D# (low)
    DB 064,206,098,007,099
    ; C (low)
    DB 064,086,099,007,080
LOSE_LIFE_TUNE_P2:
